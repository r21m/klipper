...
class GCodeParser:
    ...
    def cmd_Tn(self, params):
        ...
        #self.respond_info("gcode tn extruders "+ str(extruders))
        #self.respond_info("gcode tn e "+ str(e))
        #self.respond_info("gcode tn index  "+ str(index))
        ...
        self.actual_tool = index
    def get_actual_tool(self):
        return self.actual_tool
        ...
        try:
            ...
            if 'E' in params:
                ...
                if not self.absolutecoord or not self.absoluteextrude:
                    ...
                    #self.respond_info("last_position   " + str( self.last_position[3] ))
                else:
                    # value relative to base coordinate position
                    self.last_position[3] = v + self.base_position[3]
                    #self.respond_info("last_position   " + str( self.base_position[3] ))
            if 'F' in params:
